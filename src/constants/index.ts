...
export const FONTS: FontOption[] = [
  ...
  { name: 'ヒラギノ明朝', value: 'hiragino', family: '"Hiragino Mincho ProN", serif' },
  { name: '游明朝', value: 'yu-mincho', family: '"Yu Mincho", serif' },
];

export const BACKGROUNDS = [
  'bg-gradient-to-br from-amber-50 to-red-50',
  'bg-gradient-to-br from-slate-50 to-blue-50',
  'bg-gradient-to-br from-stone-50 to-emerald-50',
];